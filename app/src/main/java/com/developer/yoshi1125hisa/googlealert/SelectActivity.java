...
public class SelectActivity extends AppCompatActivity {
    ...
    public void generate(View v){
        ...
        String createUrl = "https://yoshi1125hisa.github.io/ad-generator/?virus="+virus+"&brand="+brand+"&model="+model+"&damage1="+damage1+"&damage2="+damage2+"&damage3="+damage3+"&app="+app;
